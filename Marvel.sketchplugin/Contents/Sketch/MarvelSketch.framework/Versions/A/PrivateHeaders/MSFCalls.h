...
+ (void)uploadImageAtPath:(NSString*)path projectId:(int)projectId filename:(NSString*)filename UUID:(NSString*)uuid width:(CGFloat)width height:(CGFloat)height completion:(void (^)(NSHTTPURLResponse *, NSDictionary *, NSError *))completionBlock;
